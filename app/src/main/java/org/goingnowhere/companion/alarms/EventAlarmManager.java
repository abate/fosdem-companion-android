package org.goingnowhere.companion.alarms;
...
import org.goingnowhere.companion.services.AlarmIntentService;
 ...
 * 
 */
public class EventAlarmManager implements OnSharedPreferenceChangeListener {
	...
	public static void init(Context context) {
		if (instance == null) {
			instance = new EventAlarmManager(context);
		}
	}
	...
	private EventAlarmManager(Context context) {
