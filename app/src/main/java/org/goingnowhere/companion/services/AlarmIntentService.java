package org.goingnowhere.companion.services;
...
import org.goingnowhere.companion.activities.EventDetailsActivity;
import org.goingnowhere.companion.activities.MainActivity;
import org.goingnowhere.companion.activities.RoomImageDialogActivity;
...
import org.goingnowhere.companion.receivers.AlarmReceiver;
import org.goingnowhere.companion.utils.StringUtils;
...
public class AlarmIntentService extends IntentService {
	...
	public static final String ACTION_UPDATE_ALARMS = "org.goingnowhere.companion.action.UPDATE_ALARMS";
	public static final String EXTRA_WITH_WAKE_LOCK = "with_wake_lock";
	public static final String ACTION_DISABLE_ALARMS = "org.goingnowhere.companion.action.DISABLE_ALARMS";
		...
		switch (intent.getAction()) {
			...
			case AlarmReceiver.ACTION_NOTIFY_EVENT: {
				...
				if (event != null) {
					...
					// Blink the LED with event color if enabled in the options
