package org.goingnowhere.companion.receivers;
...
public class AlarmReceiver extends WakefulBroadcastReceiver {
	...
	public static final String ACTION_NOTIFY_EVENT = "org.goingnowhere.companion.action.NOTIFY_EVENT";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (ACTION_NOTIFY_EVENT.equals(action)) {
			...
			if (EventAlarmManager.getInstance().isEnabled()) {
				Intent serviceIntent = new Intent(context, AlarmIntentService.class);
